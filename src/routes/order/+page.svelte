<script lang="ts">
	...
	//   steps
	let showSampleSteps: boolean = $state(true);
	let clientInformationStep: boolean = $state(false);
	let shippingInfomationStep: boolean = $state(false);
	let reviewSubmitStep: boolean = $state(false);
	let succesMessageStep: boolean = $state(false);

	let backtoSampleStep = function (): void {
	...
	const products = [
		{
			...
			desc: 'Medium size, natural jute, standard handles',
			price: 5,
			qty: toteQty
		},
		{
			...
			desc: '13-15" laptop compartment, padded interior',
			price: 8,
			qty: laptopQty
		},
		{
	...
	const customizationOptions = [
		{ id: 'none', name: 'Standard Samples', desc: 'Receive our standard product samples as-is' },
		{
			...
			desc: 'Request specific color options (additional $2 per sample)'
		},
		{
			id: 'print',
			name: 'Logo Printing',
			desc: 'Add your logo to samples (additional $5 per sample)'
		}
	];
...
<section class="page-header">
	<div class="container">
		...
		<p>
			Experience the quality of our jute and bamboo products firsthand before placing your bulk
			order
		</p>
	</div>
</section>
	...
	<div class="container">
		<div class="form-container">
			<div class="form-header">
				...
				<p>
					Complete this form to receive product samples. Sample costs will be credited to your first
					bulk order.
				</p>
			</div>
			...
			<div class="form-body">
				...
				{#if showSampleSteps}
					<div>
						...
						<div class="form-navigation">
							<div></div>
							<button class="btn" onclick={showClientInformation}>Continue to Details</button>
						</div>
					</div>
				{/if}

				<!-- Step 2: Customer Details -->
				{#if clientInformationStep}
					<div>
							...
							<div class="form-grid">
								...
								<div class="form-group full-width">
									...
									<textarea
										id="purpose"
										class="form-control"
										placeholder="Please describe how you plan to use our products..."
									></textarea>
								</div>
							</div>
							<div class="form-navigation">
								<button type="button" class="btn btn-outline" onclick={backtoSampleStep}
									>Back to Products</button
								>
								<button type="button" class="btn" onclick={showShippingInformation}
					...
					<div>
						...
						<div class="form-group full-width">
							...
							<textarea
								id="specialRequests"
								class="form-control"
								placeholder="Any specific requirements, color preferences, or additional information..."
							></textarea>
						</div>
					...
					<div>
						...
						<div class="order-summary">
							...
							<p class="form-help" style="margin-top: 15px;">
								* Sample costs (excluding shipping) will be credited toward your first bulk order of
								1,000+ units.
							</p>
						</div>
						<div class="form-navigation">
				...
				<!-- Success Message -->
				{#if succesMessageStep}
					<div class="success-message">
						<div class="success-icon">✓</div>
						<h2>Sample Request Submitted!</h2>
						<p>
							Thank you for your sample request. We have received your information and will contact
							you within 24 hours to confirm your order and provide tracking details.
						</p>
						<p>
							Your sample cost (excluding shipping) will be credited to your first bulk order of
							1,000+ units.
						</p>
						<div style="margin-top: 30px;">
							<a href="/" class="btn">Return to Homepage</a>
							<a href="/product-collection" class="btn btn-outline" style="margin-left: 15px;">Browse More Products</a
							>
						</div>
					</div>
				{/if}
...
<style>
	.page-header {
		background:
			...
			url('https://images.unsplash.com/photo-1589939705384-5185137a7f0f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');
